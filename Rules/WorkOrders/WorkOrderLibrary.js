...
export class WorkOrderLibrary {
    ...
    */
    ...
    static getWorkOrderDetailsNavQueryOption() {
        return '$select=CostCenter,OrderId,Priority,OrderDescription,ObjectKey,OrderType,DueDate,MainWorkCenter,ControllingArea,MaintenancePlant,FunctionalLocation/FuncLocDesc,MobileStatus/MobileStatus,Operations/MobileStatus/MobileStatus,Operations/SubOperations/MobileStatus/MobileStatus,HeaderEquipment,HeaderFunctionLocation,MarkedJob&$expand=WODocuments,MobileStatus,FunctionalLocation,Operations,Operations/MobileStatus,Operations/SubOperations,Operations/SubOperations/MobileStatus,WOGeometries/Geometry,MarkedJob,Confirmations';
    }
...
export class WorkOrderEventLibrary {
    ...
    static setDefaultValues(pageProxy, onCreate, onFollowUp) {
        if (onCreate && onFollowUp) {
            ...
            descriptionControl.setValue('Follow-up: ' + descriptionControl.getValue());
