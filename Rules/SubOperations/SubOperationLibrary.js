...
export class SubOperationEventLibrary {
    ...
    static setDefaultValues(pageProxy, onCreate) {
        try {
            //get controls
            let container = pageProxy.getControl('FormCellContainer');
            let description = container.getControl('DescriptionNote');
            let funcLoc = container.getControl('FunctionalLocationLstPkr');
            let equip = container.getControl('EquipmentLstPkr');
